...
# ============================================================
# 5.5 五分类数据（from bridge OID fact table）
# ============================================================
print("🏷️ [5.5/6] 五分类...")
# Use bridge FIVECAT (computed from same OID fact table)
fc = _m1['FIVECAT']
FIVECAT = {
    'n_pay': fc['n_pay'],
    'gmv_pay': fc['gmv_pay'],
